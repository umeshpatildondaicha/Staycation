...
<body>
  <div class="container" id="container">
    <div class="form-container sign-up">
      <form name="signupForm" action="customersignup" method="post" onsubmit="return validateForm()">
        ...
        <span id="address-validation-message" class="error-message"></span>
        <input type="tel" placeholder="Phone Number" name="customer_phone" maxlength="10" id="customer_phone">
        <span id="phone-validation-message" class="error-message"></span>
        <input type="email" placeholder="Email" name="customer_email" id="customer_email">
        <span id="email-validation-message" class="error-message"></span>
        <input type="password" placeholder="Password" name="customer_password" id="customer_password" oninput="checkPasswordStrength()">
        <span id="password-validation-message" class="error-message"></span>
        <span id="password-strength"></span>
        <input type="password" placeholder="Confirm Password" name="customer_confirm_password" id="customer_confirm_password" oninput="showPasswordMatchMessage()">
        <span id="confirm-password-validation-message" class="error-message"></span>
        <input type="number" placeholder="Aadhar Card Number" name="customer_aadhar" id="customer_aadhar" maxlength="12">
        <span id="aadhar-validation-message" class="error-message"></span>
        <button type="submit">Sign Up</button>
      </form>
    </div>

    <div class="form-container sign-in">
  		<form name="loginForm" action="customerlogin" method="post" onsubmit="return validateLoginForm()">
    		<h1>Login</h1>
    		<span>Use your email and password.</span>
    		<input type="email" placeholder="Email" name="customer_email" id="login-email">
    		...
    		<a href="List of Hotels.html"><button type="submit">Login</button></a>
  		</form>
	</div>
