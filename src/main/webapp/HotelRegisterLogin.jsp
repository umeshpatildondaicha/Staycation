  ...
  <div class="container" id="container">
    <div class="form-container sign-up">
      <form name="signupForm" action="hotelsignup" method="post" onsubmit="return validateForm()">
        ...
        <input type="text" placeholder="Hotel_Name" name="hotel_name"><span id="name-validation-message"></span>
        <input type="text" placeholder="Hotel_location" name="hotel_location"><span id="location-validation-message"></span>
        <input type="tel" placeholder="Hotel_Phone_Number" name="hotel_phone" maxlength="10"><span id="phone-validation-message"></span>
        <input type="email" placeholder="Hotel_Email" name="hotel_email"><span id="email-validation-message"></span>
    ...
    <div class="form-container sign-in">
  		<form name="loginForm" action="hotellogin" method="post" onsubmit="return validateLoginForm()">
    		...
    		<input type="email" placeholder="Email" name="hotel_email" id="login-email">
